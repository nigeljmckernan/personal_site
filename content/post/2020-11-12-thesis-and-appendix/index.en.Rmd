...
First, my project takes a novel approach by using an instrumental-variable (IV) approach in a panel-data context. The instrumental variables used were Wind Speed and Wind Direction.
